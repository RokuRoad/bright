...
export class RokuBRSParser extends Parser {
  public Program = this.RULE("Program", () => {
    this.MANY(() => {
      this.OR([
        ...
        {
          ALT: () =>
            this.SUBRULE(this.ConditionalCompilationStatement, Declaration),
        },
  ...
  protected BlockStatement = this.RULE("BlockStatement", () => {
    this.MANY(() => {
      this.OR([
        { ALT: () => this.SUBRULE(this.Statement, body) },
        { ALT: () => this.CONSUME(TERMINATOR) },
      ]);
    });
  });
    ...
    this.OR2(
      this.cacheStatement ||
        (this.cacheStatement = [
          ...
          {
            ALT: () =>
              this.SUBRULE(this.ConditionalCompilationStatement, Statement),
          },
  ...
  protected TryStatement = this.RULE("TryStatement", () => {
    ...
    this.CONSUME(CATCH);
    this.SUBRULE(this.ExpressionStatement, { LABEL: "exception" });
    this.SUBRULE(this.EndOfStatement, { LABEL: "trailingComments" });
    this.SUBRULE2(this.BlockStatement, { LABEL: "onError" });
    this.CONSUME(END_TRY);
  });
  ...
  protected MemberChunkExpression = this.RULE("MemberChunkExpression", () => {
    this.OR([
      ...
      {
        ALT: () =>
          this.SUBRULE(this.DotMemberExpression, { LABEL: "property" }),
      },
    ]);
  ...
  protected DotMemberExpression = this.RULE("DotMemberExpression", () => {
    this.OR1([
      { ALT: () => this.CONSUME(PERIOD, operator) },
      { ALT: () => this.CONSUME(ATTRIBUTE, operator) },
    ]);
  ...
  protected ConditionalCompilationStatement = this.RULE(
  ...
  protected ConditionalElseIfStatement = this.RULE(
  ...
  protected ConditionalElseStatement = this.RULE(
